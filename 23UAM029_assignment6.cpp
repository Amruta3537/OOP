...
int main() {
    float studentMarks[5] = {9.2, 8.7, 8.4, 8.3, 9.0};
    
    Student s1("Amruta Dumal", 20, 29, "CSE(AI-ML)", studentMarks);
    Faculty f1("ABC", 40, 209, "Computer Science(Artificial Intelligence & Machine Learning)", 80000);
    TeachingAssistant ta1("xyz", 34, 212, "AI-ML", studentMarks, 1002, "AI-ML", 60000);
